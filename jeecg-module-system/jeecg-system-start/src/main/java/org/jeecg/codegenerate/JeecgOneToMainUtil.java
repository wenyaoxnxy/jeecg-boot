...
public class JeecgOneToMainUtil {
	...
	public static void main(String[] args) {
        ...
        //表名
		mainTable.setTableName("kf_review_design");
        //实体名
		mainTable.setEntityName("ReviewDesign");
        //包名
		mainTable.setEntityPackage("design");
        //描述
		mainTable.setFtlDescription("概设评审记录");
        ...
        //表名
		po.setTableName("kf_review_design_detail");
        //实体名
		po.setEntityName("ReviewDesignDetail");
        //包名
		po.setEntityPackage("design");
        //描述
		po.setFtlDescription("概设评审明细记录");
		//子表外键参数配置
		/*说明: 
